...
public class HandMachine {
	...
	public final static int SHARE_SMS_MSG = 907;  //指定短信分享信息
	public final static int SHARE_WEIBO_MSG = 908;  //指定微博分享信息
	public final static int SHARE_WEICHAT_MSG = 909;  //指定微信分享信息
	public final static int SHARE_PYQ_MSG = 900;  //指定朋友圈分享信息
	public final static int SHARE_QQ_MSG = 968;  //指定QQ分享信息
	public final static int SHARE_OTHER_MSG = 899;  //指定其他分享
	...
	public final static int HANDLER_START_GET_CITY_INFO = 2005;//获取城市信息
	...
	public void handle(int what , Object data) {
		...
		case GUESTZH_LOGIN:
			...
			guest.login(kGuestZhLogin ,null);
			break;
		case GUESTZW_LOGIN:
