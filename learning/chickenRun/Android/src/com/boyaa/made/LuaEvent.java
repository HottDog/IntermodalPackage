...
import com.boyaa.chinesechess.chicken.HuoDongActivity;
...
//		ret.addAll(com.boyaa.bl.tools.Contacts.getPhoneContacts(Game.mActivity));
	...
	public static void LoginBoyaa(){
		String data = HandMachine.getHandMachine().getParm(HandMachine.kLoginBoyaa);
		Message msg = new Message();
		msg.what = HandMachine.HANDLER_LOGIN_WITH_BOYAA;
	...
	public static void RegisterBoyaa(){
		Message msg = new Message();
		msg.what = HandMachine.HANDLER_REGISTER_BOYAA;
		Game.getGameHandler().sendMessage(msg);
	}
...
//		 Bundle bundle = new Bundle();// 存放数据
//		 bundle.putString("data", line);
//		 msg.what = HandMachine.SHARE_IMG_MSG;
//		 msg.setData(bundle);
//		 Game.getGameHandler().sendMessage(msg);
		 
		 com.boyaa.proxy.share.ShareManager.share(TYPE_IMG);
	}
...
//		ShareEvent(TYPE_SMS);
		com.boyaa.proxy.share.ShareManager.share(TYPE_SMS);
	}
	...
	public static void ShareWEIBOMsg() {
		com.boyaa.proxy.share.ShareManager.share(TYPE_WEIBO);
//		ShareEvent(TYPE_WEIBO);
	}
...
//		ShareEvent(TYPE_WEICHAT);
		com.boyaa.proxy.share.ShareManager.share(TYPE_WEICHAT);
	}
...
//		ShareEvent(TYPE_PYQ);
		com.boyaa.proxy.share.ShareManager.share(TYPE_PYQ);
	}
	...
	public static void ShareQQMsg() {
		com.boyaa.proxy.share.ShareManager.share(TYPE_QQ);
//		ShareEvent(TYPE_QQ);
	}
	...
	public static void ShareOther() {
		...
		com.boyaa.proxy.share.ShareManager.share(TYPE_OTHER);
//		 Message msg = new Message();
//		 Bundle bundle = new Bundle();// 存放数据
//		 msg.what = HandMachine.SHARE_OTHER_MSG;
//		 msg.setData(bundle);
//		 Game.getGameHandler().sendMessage(msg);
	}
...
//		SMS.registerReceiver(Game.mActivity);
	...
	public static void loginWeChat() {
		...
		new SendToWXUtil.SendAuthToGetToken().onClick(null);
	}
...
//		Game.mActivity.startActivity(intent);
	...
	public static void CollectWebView(){
		String data = HandMachine.getHandMachine().getParm("CollectWebView");
		Message msg = new Message();
		Bundle bundle = new Bundle();
		bundle.putString("data", data);
		msg.what = HandMachine.HANDLER_COLLECTWEB;
		msg.setData(bundle);
		Game.getGameHandler().sendMessage(msg);
	}
	
	public static void CollectWebViewRefresh(){
		Message msg = new Message();
		Bundle bundle = new Bundle();
		msg.what = HandMachine.HANDLER_COLLECTWEBREFRESH;
		msg.setData(bundle);
		Game.getGameHandler().sendMessage(msg);
	}
	
	public static void CollectWebViewClose(){
		Message msg = new Message();
		Bundle bundle = new Bundle();
		msg.what = HandMachine.HANDLER_COLLECTWEBCLOSE;
		msg.setData(bundle);
		Game.getGameHandler().sendMessage(msg);
	}
	
	public static void ShareWebViewShare(){
		String data = HandMachine.getHandMachine().getParm("ShareWebViewShare");
		Message msg = new Message();
		Bundle bundle = new Bundle();
		bundle.putString("data", data);
		msg.what = HandMachine.HANDLER_SHAREWEBSHARE;
		msg.setData(bundle);
		Game.getGameHandler().sendMessage(msg);
	}
	
	public static void ResponseShareInfo(){
		String data = HandMachine.getHandMachine().getParm("ResponseShareInfo");
		Message msg = new Message();
		Bundle bundle = new Bundle();
		bundle.putString("data", data);
		msg.what = HandMachine.HANDLER_RESPONSE_SHAREINFO;
		msg.setData(bundle);
		Game.getGameHandler().sendMessage(msg);
	}
	
	public static void ResponseShareInfoFail(){
		Message msg = new Message();
		Bundle bundle = new Bundle();
		msg.what = HandMachine.HANDLER_RESPONSE_SHAREINFO_FAIL;
		msg.setData(bundle);
		Game.getGameHandler().sendMessage(msg);
	}
	
	public static void ShareToBoyaaSuccess(){
		Message msg = new Message();
		Bundle bundle = new Bundle();
		msg.what = HandMachine.SHARE_QIPU_BOYAA_SUCCESS;
		msg.setData(bundle);
		Game.getGameHandler().sendMessage(msg);
	}
	
	public static void ShareToBoyaaFail(){
		Message msg = new Message();
		Bundle bundle = new Bundle();
		msg.what = HandMachine.SHARE_QIPU_BOYAA_FAIL;
		msg.setData(bundle);
		Game.getGameHandler().sendMessage(msg);
	}
...
//		EndingUtilNew.getSubGateJsonStrByTidAndSort(tid, sort);
	 ...
	 * 调用 ShareProxy 进行分享
	 */
	public static void ShareProxy() {
		String params = Game.dict_get_string("ShareProxy","params");
		com.boyaa.proxy.share.ShareProxy.share(params);
	}
