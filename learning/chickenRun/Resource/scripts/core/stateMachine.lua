...
StateMachine.customWaitAnim = function(newStateObj,lastStateObj,switchObj,switchFn,changeStyle)
    ...
    if newStateObj.stateObj.m_controller.m_view.resumeAnimStart then
        newStateObj.stateObj.m_controller.m_view.resumeAnimStart(newStateObj.stateObj.m_controller.m_view,lastStateObj,obj);  
    end
    if lastStateObj.stateObj.m_controller.m_view.pauseAnimStart then
        lastStateObj.stateObj.m_controller.m_view.pauseAnimStart(lastStateObj.stateObj.m_controller.m_view,newStateObj,obj);
    end
