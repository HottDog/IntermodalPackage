...
--指定分享其他
SHARE_TEXT_TO_OTHER_MSG = "ShareOther";
...
HALL_MODEL_REPLAY_BTN = "hall_model_replay_btn"  --大厅复盘按钮
HALL_MODEL_DAILY_ACTIVITY_BTN = "hall_model_daily_activity_btn"  --大厅日常活动按钮
HALL_MODEL_RANK_BTN = "hall_model_rank_btn"  --大厅排行榜按钮
HALL_MODEL_SHARE_BTN = "hall_model_share_btn"  --大厅分享按钮
...
--bottom按钮统计
BOTTOM_MENU_FRIEND_CLICK = "bottom_friend_btn_click";  --大厅好友按钮点击
BOTTOM_MENU_MALL_CLICK = "bottom_mall_btn_click";      --大厅商城按钮点击
BOTTOM_MENU_HALL_CLICK = "bottom_hall_btn_click";      --大厅游戏按钮点击
BOTTOM_MENU_FIND_CLICK = "bottom_find_btn_click";      --大厅发现按钮点击
BOTTOM_MENU_OWN_CLICK = "bottom_own_btn_click";        --大厅我的按钮点击

--联网界面按钮统计
ONLINE_MODEL_NEWFISH_BTN = "online_fish_btn_click"; --联网新手场按钮点击
ONLINE_MODEL_MIDDLE_BTN = "online_middle_btn_click"; --联网中级场按钮点击
ONLINE_MODEL_MASTER_BTN = "online_master_btn_click"; --联网大师场按钮点击
ONLINE_MODEL_SPORTS_BTN = "online_sports_btn_click"; --联网竞技场按钮点击
ONLINE_MODEL_WATCH_BTN = "online_watch_btn_click"; --联网观战按钮点击
ONLINE_MODEL_PRIVATE_BTN = "online_private_btn_click"; --联私人房按钮点击
