...
PhpConfig.genTreeMap=function(t)
    t.lua_versions  = kLuaVersion;
    if System.getPlatform() == kPlatformWin32 then
        t.versions = kWin32Vesion;
    else
        t.versions = System.getAndroidVersionName(); 
    end
...
--统计地址
PhpConfig.setLogUrl = function(url)
    PhpConfig.countUrl = url;
    HttpModule.initConfig();
end

PhpConfig.getLogUrl = function()
    return PhpConfig.countUrl or "";
end
...
PhpConfig.APPID_HUAWEI = "3";
PhpConfig.APPKEY_HUAWEI = "3";
PhpConfig.BID_HUAWEI = "_huawei";
--百度移动游戏接入

--百度帖吧
PhpConfig.APPID_BAIDUAGME_TIEBA = "113092";
PhpConfig.APPKEY_BAIDUAGME_TIEBA = "30B7752155FF344F1E5ECCE9CE3F84EE";
PhpConfig.BID_BAIDUAGME_TIEBA = "_baidutieba";
--百度助手
PhpConfig.APPID_BAIDUAGME_ZHUSHOU = "113091";
PhpConfig.APPKEY_BAIDUAGME_ZHUSHOU = "7926260962EE734E194EB70757E84274";
PhpConfig.BID_BAIDUAGME_ZHUSHOU = "_baiduzhushou";
--百度91
PhpConfig.APPID_BAIDUAGME_91 = "113090";
PhpConfig.APPKEY_BAIDUAGME_91 = "FB386B16BA1C8F4E85DF671C77DC242B";
PhpConfig.BID_BAIDUAGME_91 = "_baidu91";
--百度多酷
PhpConfig.APPID_BAIDUAGME_DUOKU = "113089";
PhpConfig.APPKEY_BAIDUAGME_DUOKU = "0389AB655D1AF6A97161CA45AEB83FA4";
PhpConfig.BID_BAIDUAGME_DUOKU = "_baiduduoku";
--帐号类型
