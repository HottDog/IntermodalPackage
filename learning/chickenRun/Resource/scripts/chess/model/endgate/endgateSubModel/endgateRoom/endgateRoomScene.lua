...
EndgateRoomScene.init = function(self)
	...
	self.m_ending_num = self.m_ending_title_bg:getChildByName("ending_num");
...
--	self.m_room_menu2_bg = self.m_root_view:getChildByName("ending_room_menu2_bg");
	self.m_restart_btn = self.m_room_menu_view:getChildByName("ending_room_restart_btn");
	self.m_restart_btn:setOnClick(self,self.restart_action);

	self.m_set_btn = self.m_room_menu_view:getChildByName("ending_room_set_btn");
	...
	self.m_share_btn = self.m_ending_room_title:getChildByName("ending_share_btn");
